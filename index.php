...
// if($_SESSION['signInSuccessful'])
// {
//  $name = $_SESSION['signInSuccessful'][1];
 //echo "$name";
  // echo "
  //   <script type='text/javascript'>
  //     alert('Hello $name you're successfully signed into facebook \n Login to connect with your friends')
  //   </script>";
  ...
  <div id="navbar"> 
    <table class="tablewrapper">
      ...
      <form action="loginphp.php" method="post">
        <tr>
          <td><input type="text" class="inputtext" name="login_mail_number">
          </td>
  ...
  <div id="content">
    ...
    <div id="leftbod">
      ...
      <div id="rightbod">
        ...
        <form action="registerphp.php" method="post" name="Register">
          <div class="formbox">
            <input type="text" class="inputbody in1" placeholder="First name" name="fname" onchange="validate()">
            <input type="text" class="inputbody in1 fr" placeholder="Last name" name="lname" onchange ="validate()">
          </div>
          <div class="formbox">
            <input type="text" class="inputbody in2" placeholder="Email or mobile number" name="emailOrNo" onchange ="validate()">
          </div>
          <div class="formbox">
            <input type="text" class="inputbody in2" placeholder="Re-enter email or mobile number" name="confirmEmailOrNo" onchange ="validate()">
          </div>
          <div class="formbox">
            <input type="text" class="inputbody in2" placeholder="New password" name="newPass" onchange ="validate()">
          </div>
          <div class="formbox">
          ...
          <div class="formbox">
            <span data-type="selectors">
              <span>
                <select title="Month" class="selectbody" name="bdMonth" onchange ="validate()">
                ...
                <select title="Day" class="selectbody fl" name="bdDate" onchange ="validate()">
                ...
                <select title="Year" class="selectbody fl" name="bdYear" onchange ="validate()">
          ...
          <div class="formbox mt1" onchange ="validate()">
            <span data-type="radio" class="spanpad">
              <input type="radio" id="fem" class="m0" name="gen" value="female">
              <label for="fem" class="gender">Female
              </label>
              <input type="radio" id="male" class="m0" name="gen" value="male">
              <label for="male" class="gender">Male
              <input type="radio" id="male" class="m0" name="gen" value="others">
              <label for="male" class="gender">Others
              </label>
            </span>
          </div>
          <div class="formbox">
          ...
          <div class="formbox">
            <button type="submit" class="signbut bolder" name="register" onsubmit="validate()">Sign Up</button>
          </div>
          <div class="formbox">
